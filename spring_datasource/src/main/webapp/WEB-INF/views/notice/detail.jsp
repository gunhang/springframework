				...
				<div class="card card-outline card-info">
					<div class="card-header">
						...
						<div class ="card-tools">
							<button type="button" class="btn btn-primary" id="modifyBtn" onclick="modify_go('${notice.nno}')">수정</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="btn btn-danger" id="removeBtn" onclick="remove_go('${notice.nno}')">삭제</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
