...
public class BasicController {
	...
	public String test5Param(@RequestParam(name="message", defaultValue = "dd") String msg, Model model) {
		String url="test/main";
	...
	public void test6Param(CommandObject command, HttpServletResponse response)throws Exception {
		...
		out.println(command.getA()+":"+command.getB()+":"+command.getC()+":"+command.getD()+":"+command.isK());
	}
